...
public:
	...
	// 各種設定
	void SetPos(const D3DXVECTOR3 &pos) { m_obb.pos = pos; }				// 位置
	void SetSize(const D3DXVECTOR3 &size) { m_obb.size = size; }			// 大きさ
	void SetRot(const D3DXVECTOR3 &rot) { m_obb.rot = rot; }				// 角度
	void SetCollisionType(const TYPE &type) { m_obb.CollisionType = type; }	// 種類

	OBB GetOBB() { return m_obb; }	// OBBの取得

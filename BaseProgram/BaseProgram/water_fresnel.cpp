...
// インスタンス生成
//=============================================================================
CWaterFresnel * CWaterFresnel::Create(void)
{
	// メモリ確保
...
// 初期化処理
//=============================================================================
HRESULT CWaterFresnel::Init(void)
{
	// 初期化処理
	CModel::Init();
...
// 終了処理
//=============================================================================
void CWaterFresnel::Uninit(void)
{
	if (m_pWave)
	{
		m_pWave->Uninit();
...
// 更新処理
//=============================================================================
void CWaterFresnel::Update(void)
{
	// 更新処理
	CModel::Update();
